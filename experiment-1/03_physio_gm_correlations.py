...
RPV correlated with SD of global fMRI signal from ME-DN data
-   Correlation across subjects
-   Page 3, left column, second paragraph

RPV correlated with SD of global fMRI signal from ME-DN+GODEC data
-   Correlation across subjects
-   Figure 2B

RPV correlated with SD of global fMRI signal from ME-DN+Nuis
...
RPV correlated with SD of global fMRI signal from ME-DN+RV+RV*RRF data
-   Correlation across subjects
-   Figure S8
...
HRV correlated with SD of global fMRI signal from ME-DN data
-   Correlation across subjects
-   Page 3, left column, second paragraph
