...
def compare_cnr(
    ...
    dset_prefix_mni = get_prefixes_mni()["dset-dalenberg"]
    ...
    for i_run, participant_row in participants_df.iterrows():
        ...
        roi_file = roi_file_pattern.format(prefix=subj_prefix_mni)
...
if __name__ == "__main__":
    ...
    roi_file_pattern = op.join(
        in_dir,
        "derivatives/power/{participant_id}/anat/{prefix_mni}_desc-V1_mask.nii.gz",
    )
